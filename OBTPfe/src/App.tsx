  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {!expandedPortal ? (
        ...
        <div
          className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-4 space-y-3 animate-scale-in"
